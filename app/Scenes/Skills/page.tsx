...
const Skills: React.FC = () => {
    ...
    const styles = {
        ...
        description: 'text-white text-center text-md mx-16 mb-8 md:mb-16 lg:mb-16',
    ...
    return (
        <div id='skills' className='bg-[#213251] w-full'>
            ...
            <p className={styles.description}>Below is a list of the main languages, frameworks and databases I work in.</p>
